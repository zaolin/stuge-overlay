...
SRC_URI="xmms2-${MY_PV}.tar.bz2"

LICENSE="GPL-2 LGPL-2.1"
SLOT="0"
KEYWORDS="~x86 ~amd64"
IUSE="aac alsa ao avahi cli coreaudio curl cxx fam flac gnome jack mad mms modplug mp4 mpg123 musepack nophonehome ofa perl pulseaudio python resid rss ruby samba shout sid speech vorbis wma xml"
...
disable_plugins() {
	...
	for x in alsa aac:faad avahi:daap ao coreaudio curl flac gnome:gvfs jack mad mms modplug mp4:avformat musepack ofa rss samba shout:ices sid speech:vocoder vorbis xml:xspf ; do
		if ! use ${x/:*} ; then
